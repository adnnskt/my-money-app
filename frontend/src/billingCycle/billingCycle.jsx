...
class BillingCycle extends Component {
    ...
    componentWillMount(){
        ...
        /*
        this.props.selectTab('tabList') //função necessária para inicializar a aplicação com o Tablist
        this.props.showTabs('tabList', 'tabCreate')
        */ // descuntinuado pelo carregamento da função init.

        this.props.init() // função necessária para inicialização das abas
    }
